...
public class RegisterDao {
 ...
 String Reg_Date = registerBean.getReg_Date();

// System.out.println(dtf.format(Reg_Datee)); //2016/11/16

String Cust_ID = Cust_First_Name + "101" ;
 ...
 preparedStatement.setString(6, Reg_Date);
